...
export default function About() {
  return (
    <section id="about" className="section-block bg-white">
      <div className="site-container grid gap-10 md:grid-cols-2 md:gap-12 lg:gap-16 md:items-stretch">
        {/* Left: Content */}
        <div className="flex flex-col justify-center">
          ...
          <p className="text-[#525252] text-base md:text-lg leading-relaxed max-w-lg mb-12">
            ...
            10 packages are executed flawlessly. From NFPA life safety
            compliance to value engineering, we pride ourselves on getting the
            job done right the first time, every time.
          </p>
        ...
        {/* Right: Image */}
        <div className="relative min-h-[24rem] md:min-h-0 bg-[#F5F5F5]">
          <Image
