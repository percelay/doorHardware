...
export default function Hero() {
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 px-8 md:px-16 lg:px-24 pb-16 md:pb-24">
        <div className="max-w-4xl">
          ...
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-10">
            Serving contractors and building owners since 1909. We stock, build,
            and deliver premium hollow metal doors, architectural hardware, and
            wood doors with uncompromising precision.
          </p>
      ...
      <div className="absolute bottom-16 md:bottom-24 right-8 md:right-16 lg:right-24 hidden lg:flex flex-col gap-6">
        {[
