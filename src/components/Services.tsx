...
export default function Services() {
  return (
    <section id="services" className="bg-black py-24 px-6 md:px-12 lg:px-24">
      {/* Section header */}
      <div className="max-w-7xl mx-auto mb-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <p className="text-white/50 text-sm max-w-sm leading-relaxed">
            From specification through final inspection, our capabilities cover
            every phase of your commercial door and hardware project.
          </p>
        </div>
      </div>
